...
function afficherContacts() {
    ...
    <div id="icon">
        <button id="edit_btn" onclick="editContact(${indexContact})"> <img src="Vector.png" alt="" > </button>
        <button id="delet_btn" onclick="suprimeContact(${indexContact})"> <img src="VectorSupp.png" alt="" > </button>
    </div>
</div>`
    })
    document.querySelector('form').reset();
